    ...
    <>
      ...
      <div className="">
        ...
        <div className="mx-4 p-4 sm:mx-24 grid sm:grid-cols-3  mt-6">
          ...
          <div className="flex flex-col items-center mb-4 sm:mr-12 ">
            <img alt="logo oama cantando" className="h-32 w-32 p-2 mb-4  " src="/2.png"></img>
            <div>            <h2 className="text-lg font-bold"> Tente identificar os sons</h2>
            <p className="text-md">
          ...
          <div className="flex flex-col items-center mb-4 sm:mr-12 ">
            ...
            <div>            <h2 className="text-lg font-bold"> Continue estudando</h2>
            <p className="text-md">
